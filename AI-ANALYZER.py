...
symptoms = st.text_input("Symptoms *(Example: high-grade fever, lethargy, headache, and abdominal pain for two days)*", value="none", max_chars=500 ,help=":green[**List all symptoms indicating the presence of an underlying medical condition**]")
exam_findings = st.text_input("Examination Findings *(Example: petechial lesions on the palms of his hands and feet, bug bites)*", value="none", max_chars=500, help=":green[**List all the information gathered through visual inspection, palpation, percussion, and auscultation during the examination**]")

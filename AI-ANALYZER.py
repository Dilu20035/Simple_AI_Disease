...
st.set_page_config(page_title="HDA-AI-ANALYZER", page_icon=None, layout="centered", initial_sidebar_state="expanded", menu_items=None)
...
context = st.text_input("Patient's Background *(Example: gone to an outdoor music festival in north america, shared drinks and cigarettes with friends with similar symptoms)*", placeholder="none", value="", max_chars=500 ,help=":green[**Enter patient's known background information, including their past medical conditions, medications, family history, lifestyle, and other relevant information that can help in diagnosis and treatment**]")
symptoms = st.text_input("Symptoms *(Example: high-grade fever, lethargy, headache, and abdominal pain for two days)*", placeholder="none", value="", max_chars=500 ,help=":green[**List all symptoms indicating the presence of an underlying medical condition**]")
exam_findings = st.text_input("Examination Findings *(Example: petechial lesions on the palms of his hands and feet, bug bites)*", placeholder="none", value="", max_chars=500, help=":green[**List all the information gathered through visual inspection, palpation, percussion, and auscultation during the examination**]")
lab_results = st.text_input("Laboratory Test Results *(Example: w/IgE levels > 3000 IU/m)*", placeholder="none", value="", max_chars=500, help=":green[**List output of tests performed on samples of bodily fluids, tissues, or other substances to help diagnose, monitor, or treat medical conditions. These tests can include blood tests, urine tests, imaging tests, biopsies, and other diagnostic procedures**]")

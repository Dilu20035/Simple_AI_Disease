...
st.set_page_config(page_title="HDA-AI-ANALYZER", page_icon=None, layout="wide", initial_sidebar_state="expanded", menu_items=None)
    ...
    <div class="collapse navbar-collapse justify-content-center align-items-center " id="navbarNav">
        <ul class="navbar-nav ">
            <li class="nav-item active" style="margin-right: 45rem; font-size: 1.2rem;">
                <a class="nav-link " href="#"><b> AI-Analyzer </b><span class="sr-only">(current)</span></a>
            </li>
            <li>
                <div>
                    <a href="https://hdaanalyzer.000webhostapp.com/ai-analyzer.php" target="_self"><button style="background-color: #fff; color: #443e85; padding: 0.5rem 1rem; border: none; cursor: pointer; border-radius: 1rem; margin-top: 3px;">Close</button></a>
                </div>
            </li>
        </ul>
    </div>
    ...
    if symptoms != "none":
        ...
        with st.spinner("Generating diagnostic details..."):
            ...
            response = openai.Completion.create(
                engine="gpt-3.5-turbo-instruct",  # Use Codex engine for code-based tasks
